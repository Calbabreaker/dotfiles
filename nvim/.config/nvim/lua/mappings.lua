...
register_mappings("w", {
    ...
    { "[g",         "<cmd>lua vim.diagnostic.goto_prev()<CR>",                                                 desc = "Go to next diagnostic" },
    { "[h",         "<cmd>lua require('gitsigns.actions').prev_hunk()<CR>",                                    desc = "Previous git hunk" },
    { "]g",         "<cmd>lua vim.diagnostic.goto_next()<CR>",                                                 desc = "Go to previous diagnostic" },
    { "]h",         "<cmd>lua require('gitsigns.actions').next_hunk()<CR>",                                    desc = "Next git hunk" },
    { "gD",         "<cmd>lua vim.lsp.buf.declaration()<CR>",                                                  desc = "Go to declaration" },
    { "gR",         "<cmd>lua vim.lsp.buf.references()<CR>",                                                   desc = "Populate quick fix with references" },
    { "gd",         "<cmd>lua vim.lsp.buf.definition()<CR>",                                                   desc = "Go to definition" },
    { "gi",         "<cmd>lua vim.lsp.buf.implementation()<CR>",                                               desc = "Go to implementation" },
    { "gl",         "<cmd>lua vim.diagnostic.open_float()<CR>",                                                desc = "Show diagnostics on line" },
    ...
    -- Search and find
    { "<Leader>f",  group = "Find" },
    { "<Leader>fc", "<cmd>lua require('telescope.builtin.internal').colorscheme({enable_preview = true})<CR>", desc = "Find and select color scheme" },
    ...
    { "<Leader>l",  group = "LSP" },
    { "<Leader>lD", "<cmd>Telescope diagnostics<cr>",                                                          desc = "Show workspace diagnostics" },
    ...
    { "<Leader>ld", "<cmd>Telescope diagnostics bufnr=0<cr>",                                                  desc = "Show document diagnostics" },
